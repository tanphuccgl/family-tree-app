...
part 'select_area_family_tree_state.dart';

class SelectAreaFamilyTreeBloc extends Cubit<SelectAreaFamilyTreeState> {
  final BuildContext context;
  SelectAreaFamilyTreeBloc(this.context) : super(SelectAreaFamilyTreeState()) {
    init();
  }
  ...
  void onSelectArea(AreaModel value) async {
    ...
    context.read<FamilyTreeBloc>().onChangeCurrentArea(state.selectedArea);
  }
