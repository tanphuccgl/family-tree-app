...
part 'female_individuals_state.dart';

class FemaleIndividualsBloc extends Cubit<FemaleIndividualsState> {
  final BuildContext context;

  FemaleIndividualsBloc(this.context) : super(FemaleIndividualsState()) {
    init();
  }
  ...
  void onSearchButton() async {
    ...
    if (result.isSuccess) {
      final list = result.data!
          .where((element) =>
              element.id.toLowerCase().contains(state.searchText.toLowerCase()))
          .toList();
